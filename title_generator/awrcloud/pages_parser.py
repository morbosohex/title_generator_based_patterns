from title_generator.awrcloud.awr_items import AwrKeyword, AwrGroup
...
def parse_id(javascript):
    ...
    if index_open > index_close:
        raise Exception(
            "Malformed javascript parenthesis to parse id : " + javascript)
...
def parse_projects_from_html(content):
    ...
    if (len(div_table) == 0):
        raise Exception(
            ...
            Probably a wrong username and password")
